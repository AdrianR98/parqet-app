        ...
        <section className={styles.hero}>
            <div className={styles.left}>
                ...
                <div className={styles.copy}>
                    ...
                    {/* Neue Warn-Kachel direkt in der HeroSection.
              Sie zeigt nur, ob fachliche Auffaelligkeiten in der Rekonstruktion erkannt wurden. */}
                    <div className={styles.warningTile}>
                        <div className={styles.warningTileLabel}>Datenkonsistenz</div>
                        <div
                            className={`${styles.warningTileValue} ${consistencyWarningCount > 0 ? styles.warningTileAlert : styles.warningTileOk
                                }`.trim()}
                        >
                            {consistencyWarningCount > 0
                        ...
                        <div className={styles.warningTileHint}>
                            Prüft rekonstruierte Bestände, Kostenbasis und auffällige Historien.
                        </div>
                    </div>
                </div>
            </div>
